...
class CalendarController extends AbstractBackendController
{
    ...
    protected function modifyTableConfiguration(): void
    {
        ...
        $this->tableConfiguration['tx_ximatypo3calendar_domain_model_event']['columns']['category']['defaultPosition'] = 3;
